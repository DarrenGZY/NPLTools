//------------------------------------------------------------------------------
// <copyright file="NPLPackage.cs" company="Company">
...
namespace NPLTools
{
    ...
    [Guid(NPLPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class NPLPackage : CommonPackage
    {
        /// <summary>
        /// NPLPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "596d23bd-9047-4896-b254-c194da1f4616";
        ...
        #region CommonPackage Abstracts
