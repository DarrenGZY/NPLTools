...
namespace NPL.Classifier
{
    ...
    internal sealed class OokClassifier : ITagger<ClassificationTag>
    {
        ...
        public IEnumerable<ITagSpan<ClassificationTag>> GetTags(NormalizedSnapshotSpanCollection spans)
        {
            ...
            //{
            //    ITextSnapshotLine containgLine = curSpan.Start.GetContainingLine();

            //        yield return
            //        new TagSpan<ClassificationTag>(new SnapshotSpan(curSpan.Snapshot, new Span(0, 2)), new ClassificationTag(_ookTypes[OokTokenTypes.OokExclamation]));
